...
5. Deprecated Diamond scores still circulate as the benchmark's public numbers, with no disclosed reason or comparability guidance. No ownership statement appears on the pages reviewed, while SWE-1.7 is scored on the board (F5, Governance).
