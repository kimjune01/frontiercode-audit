...
**Falsifier:** a disclosure naming the judge model(s) and version(s) per criterion class, with a pinned-version policy per leaderboard revision, and an ablation showing rank stability across judge families.
